...
- **EDE-PLANNING-001 Wave A:** feature module at `src/features/planning/**` + demo route `/(app)/w/[weddingId]/planning` + `e2e/planning.spec.ts`. Local `PlanningRepository` only. Status `READY_FOR_DATA_INTEGRATION`. No migrations. Not merged.
